    ...
    <div className="dashboard-content" style={{ paddingBottom: '100px' }}>
      ...
      <div className="premium-card">
        ...
        <div style={{ padding: '0', background: 'white', textAlign: 'center', borderBottom: '1px solid #e2e8f0' }}>
          <h2 style={{ fontSize: 'var(--fs-18, 18px)', fontWeight: 'bold', padding: '16px 0', margin: '0' }}>{t("Sales Report")}</h2>
        </div>
          ...
          <div className="table-responsive">
            <table className="custom-table" style={{ width: '100%', fontSize: 'var(--fs-11, 11px)', textAlign: 'center' }}>
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan="13" style={{ padding: '24px', textAlign: 'center' }}>{t("Loading sales report...")}</td>
                  </tr>
                ) : reports.length === 0 ? (
                  <tr>
                    <td colSpan="13" style={{ padding: '24px', textAlign: 'center' }}>{t("No sales records found.")}</td>
                  </tr>
                ) : (
                  reports.map((row, idx) => (
                    <tr key={row.id || idx}>
