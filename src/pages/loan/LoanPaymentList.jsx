...
const LoanPaymentList = () => {
  ...
  // 2. Fetch Loans from API whenever filters change
  ...
  // 3. Client-side robust filtering to guarantee exact match even if backend doesn't filter
  ...
  return (
    <div className="dashboard-content" style={{ paddingBottom: '100px', background: 'white' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <h2 style={{ fontSize: 'var(--fs-18, 18px)', fontWeight: 'normal', color: '#333', margin: 0 }}>{t("Loan Payment List")}</h2>
        <div className="card-actions" style={{ display: 'flex', gap: '8px' }}>
          <button className="btn btn-primary" onClick={() => navigate('/loan/payment-create')} style={{ background: '#10b981', color: 'white', border: 'none', padding: '6px 14px', fontSize: 'var(--fs-13, 13px)', borderRadius: '4px', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', fontWeight: 'bold' }}>
            <Plus size={15} /> {t("Add Loan Payment")}
          </button>
        </div>
      </div>
      ...
      <div className="card-body">
        ...
        <div className="no-print" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button className="btn-blue" onClick={() => exportVisibleTable('xlsx', 'Loan_Payment_List')} style={{ background: '#059669', color: 'white', padding: '6px 14px', fontSize: 'var(--fs-13, 13px)', borderRadius: '4px', border: 'none', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', fontWeight: 'bold' }}>
                ...
                return (
                  <tr key={loan.id || index} style={{ background: index % 2 === 0 ? 'white' : '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <td style={{ textAlign: 'center', padding: '10px 8px', borderRight: '1px solid #e2e8f0', fontSize: 'var(--fs-12, 12px)' }}>
                      <span style={{ padding: '3px 8px', borderRadius: '4px', fontSize: 'var(--fs-11, 11px)', fontWeight: 'bold', background: '#fee2e2', color: '#991b1b' }}>
                        {loan.type || t("Loan Payment")}
                      </span>
                    </td>
                    ...
                    <td style={{ textAlign: 'right', padding: '10px 12px', borderRight: '1px solid #e2e8f0', fontWeight: 'bold', color: '#b91c1c' }}>{displayAmt} ৳</td>
